...
No exemplo acima, no return, estou criando uma lista singleton e concatenando com a chamada recursiva com o restante da lista. Os resultados vão ser igual ao do exemplo anterior.
...
A segunda lei (idempotência) diz que não importa quantas vezes eu filtre a lista com *o mesmo predicado* o resultado sempre será o mesmo. 
